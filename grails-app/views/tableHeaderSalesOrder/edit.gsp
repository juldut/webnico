...
<html>
	...
	<body>
		<a href="#edit-tableHeaderSalesOrder" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-tableHeaderSalesOrder" class="content scaffold-edit" role="main">
			...
			<g:form method="post" >
				...
				<g:hiddenField name="version" value="${tableHeaderSalesOrderInstance?.version}" />
				<fieldset class="form">
