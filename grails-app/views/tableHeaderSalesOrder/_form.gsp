...
<div class="fieldcontain ${hasErrors(bean: tableHeaderSalesOrderInstance, field: 'nomorHeaderSalesOrder', 'error')} ">
	...
	<g:textField name="nomorHeaderSalesOrder" maxlength="15" value="${tableHeaderSalesOrderInstance?.nomorHeaderSalesOrder}"/>
</div>

<div class="fieldcontain ${hasErrors(bean: tableHeaderSalesOrderInstance, field: 'tanggalTertera', 'error')} ">
...
<div class="fieldcontain ${hasErrors(bean: tableHeaderSalesOrderInstance, field: 'idCustomer', 'error')} ">
...
<div class="fieldcontain ${hasErrors(bean: tableHeaderSalesOrderInstance, field: 'approvedBy', 'error')} ">
...
<div class="fieldcontain ${hasErrors(bean: tableHeaderSalesOrderInstance, field: 'namaCustomer', 'error')} ">
...
<div class="fieldcontain ${hasErrors(bean: tableHeaderSalesOrderInstance, field: 'alamatPengiriman', 'error')} ">
...
<div class="fieldcontain ${hasErrors(bean: tableHeaderSalesOrderInstance, field: 'nomorPoCustomer', 'error')} ">
...
<div class="fieldcontain ${hasErrors(bean: tableHeaderSalesOrderInstance, field: 'tanggalSystem', 'error')} ">
...
<div class="fieldcontain ${hasErrors(bean: tableHeaderSalesOrderInstance, field: 'username', 'error')} ">
	<label for="username">
...
<div class="fieldcontain ${hasErrors(bean: tableHeaderSalesOrderInstance, field: 'pakaiPpn', 'error')} ">
	<label for="pakaiPpn">
...
<div class="fieldcontain ${hasErrors(bean: tableHeaderSalesOrderInstance, field: 'status', 'error')} ">
	<label for="status">
...
<div class="fieldcontain ${hasErrors(bean: tableHeaderSalesOrderInstance, field: 'terminPembayaran', 'error')} ">
...
<div class="fieldcontain ${hasErrors(bean: tableHeaderSalesOrderInstance, field: 'namaSalesman', 'error')} ">
...
<div class="fieldcontain ${hasErrors(bean: tableHeaderSalesOrderInstance, field: 'idSalesman', 'error')} ">
...
<div class="fieldcontain ${hasErrors(bean: tableHeaderSalesOrderInstance, field: 'jenisNota', 'error')} ">
	<label for="jenisNota">
...
<div class="fieldcontain ${hasErrors(bean: tableHeaderSalesOrderInstance, field: 'nomorNpwp', 'error')} ">
	<label for="nomorNpwp">
...
<div class="fieldcontain ${hasErrors(bean: tableHeaderSalesOrderInstance, field: 'namaNpwp', 'error')} ">
	<label for="namaNpwp">
...
<div class="fieldcontain ${hasErrors(bean: tableHeaderSalesOrderInstance, field: 'alamatNpwp', 'error')} ">
